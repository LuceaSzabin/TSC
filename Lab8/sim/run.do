...
# Load project
  eval vsim -novopt -quiet -nocoverage +notimingchecks +nowarnTSCALE -sva -sv_seed $1 +numberOfTransactions=$2 top
 # eval vsim -novopt -quiet -coverage +code=bcesft +notimingchecks +nowarnTSCALE -sv_seed $1 +numberOfTransactions=$2 -sva top
